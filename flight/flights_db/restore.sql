...
CREATE DATABASE demo WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'English_United States.1252';
...
--
-- Name: demo; Type: DATABASE PROPERTIES; Schema: -; Owner: postgres
--

ALTER DATABASE demo SET search_path TO 'bookings', 'public';
...
COPY bookings.aircrafts_data (aircraft_code, model, range) FROM stdin;
\.
COPY bookings.aircrafts_data (aircraft_code, model, range) FROM '$$PATH$$/3392.dat';

--
-- Data for Name: airports_data; Type: TABLE DATA; Schema: bookings; Owner: postgres
--

COPY bookings.airports_data (airport_code, airport_name, city, coordinates, timezone) FROM stdin;
\.
COPY bookings.airports_data (airport_code, airport_name, city, coordinates, timezone) FROM '$$PATH$$/3393.dat';

--
-- Data for Name: boarding_passes; Type: TABLE DATA; Schema: bookings; Owner: postgres
--

COPY bookings.boarding_passes (ticket_no, flight_id, boarding_no, seat_no) FROM stdin;
\.
COPY bookings.boarding_passes (ticket_no, flight_id, boarding_no, seat_no) FROM '$$PATH$$/3394.dat';
...
\.
COPY bookings.bookings (book_ref, book_date, total_amount) FROM '$$PATH$$/3395.dat';

--
-- Data for Name: flights; Type: TABLE DATA; Schema: bookings; Owner: postgres
--

COPY bookings.flights (flight_id, flight_no, scheduled_departure, scheduled_arrival, departure_airport, arrival_airport, status, aircraft_code, actual_departure, actual_arrival) FROM stdin;
\.
COPY bookings.flights (flight_id, flight_no, scheduled_departure, scheduled_arrival, departure_airport, arrival_airport, status, aircraft_code, actual_departure, actual_arrival) FROM '$$PATH$$/3396.dat';

--
-- Data for Name: seats; Type: TABLE DATA; Schema: bookings; Owner: postgres
--

COPY bookings.seats (aircraft_code, seat_no, fare_conditions) FROM stdin;
\.
COPY bookings.seats (aircraft_code, seat_no, fare_conditions) FROM '$$PATH$$/3398.dat';

--
-- Data for Name: ticket_flights; Type: TABLE DATA; Schema: bookings; Owner: postgres
--

COPY bookings.ticket_flights (ticket_no, flight_id, fare_conditions, amount) FROM stdin;
\.
COPY bookings.ticket_flights (ticket_no, flight_id, fare_conditions, amount) FROM '$$PATH$$/3399.dat';

--
-- Data for Name: tickets; Type: TABLE DATA; Schema: bookings; Owner: postgres
--

COPY bookings.tickets (ticket_no, book_ref, passenger_id, passenger_name, contact_data) FROM stdin;
\.
COPY bookings.tickets (ticket_no, book_ref, passenger_id, passenger_name, contact_data) FROM '$$PATH$$/3400.dat';

--
-- Name: flights_flight_id_seq; Type: SEQUENCE SET; Schema: bookings; Owner: postgres
--

SELECT pg_catalog.setval('bookings.flights_flight_id_seq', 33121, true);
